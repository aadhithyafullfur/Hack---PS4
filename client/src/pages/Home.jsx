...
import { initPageTracking } from "../utils/engagementTracker";
    ...
    <>
      ...
      >
        ...
        <div className="container">
          <div style={{ maxWidth: "900px", margin: "0 auto" }}>
            ...
            >
              See critical metrics, analyze performance, and optimize your
              growth — all in one place without complexity.
            </p>
      ...
      >
        <div className="container" style={{ textAlign: "center" }}>
          ...
          >
            Trusted by 20,000+ scaling teams & agencies
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            <div className="glass-card">
              ...
              <p style={{ fontSize: "0.95rem" }}>
                Bring all your lead data together from any source instantly.
              </p>
            </div>
            <div className="glass-card">
              <div
              ...
              <p style={{ fontSize: "0.95rem" }}>
                Clean, enrich, and merge data automatically for accuracy.
              </p>
            </div>
            <div className="glass-card">
              <div
              ...
              <p style={{ fontSize: "0.95rem" }}>
                Beautiful real-time dashboards that anyone can read.
              </p>
            </div>
            <div className="glass-card">
              <div
              ...
              <p style={{ fontSize: "0.95rem" }}>
                Spot insights and emerging trends instantly with AI.
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(to right, rgba(20,20,25,0.5), rgba(10,10,15,0.8))",
        }}
      >
        <div className="container">
          <div
          ...
          >
            <div>
              ...
              <p style={{ fontSize: "1.1rem", marginBottom: "1rem" }}>
                Most teams struggle to connect the dots between clicks, leads,
                and revenue. Manual spreadsheets are slow, error-prone, and
                provide zero predictive value.
              </p>
              <p style={{ fontSize: "1.1rem", marginBottom: "2rem" }}>
                I TECH eliminates the guesswork by unifying your stack into a
              ...
              >
                <div className="glass-card" style={{ padding: "1.5rem" }}>
                  ...
                  >
                    {" "}
                    <Zap size={20} color="#60a5fa" /> Measure What Matters
                  </h4>
                  <p style={{ marginBottom: 0, fontSize: "0.9rem" }}>
                    Know your most critical KPI numbers instantly.
                  </p>
                </div>
                <div className="glass-card" style={{ padding: "1.5rem" }}>
                  <h4
                  ...
                  >
                    {" "}
                    <Activity size={20} color="#60a5fa" /> Understand
                    Performance
                  </h4>
                  <p style={{ marginBottom: 0, fontSize: "0.9rem" }}>
                    See trends at a glance with historical modeling.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "4rem" }}>
            <h2 style={{ fontSize: "2.5rem" }}>
              Why Growing Teams Choose I TECH
            </h2>
          </div>
          <div
            className="grid grid-cols-4 gap-8"
          ...
          >
            {[
              ...
              >
                <item.icon
                  size={32}
                  style={{ margin: "0 auto 1.5rem", color: "#60a5fa" }}
                />
        ...
        <div className="container">
          ...
          >
            <h2 style={{ fontSize: "3rem", marginBottom: "1.5rem" }}>
              Get Started With Intelligent Lead Insights
            </h2>
            <p
              style={{
                fontSize: "1.2rem",
