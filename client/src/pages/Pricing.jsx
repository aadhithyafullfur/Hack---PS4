...
const Pricing = () => {
  ...
  React.useEffect(() => {
    const cleanup = initPageTracking("/pricing");
    return cleanup;
  }, []);

  const handlePricingClick = (planName) => {
    incrementEngagement("pricing_page_click", null, { plan: planName });
    navigate("/checkout");
  };
    ...
    <>
      ...
      >
        <div className="container" style={{ maxWidth: "800px" }}>
          ...
          >
            Simple to Start,{" "}
            <span style={{ color: "#60a5fa" }}>Built to Scale</span>
          </h1>
          <p
            style={{
              fontSize: "1.25rem",
          ...
          >
            Everyone starts with a free 14-day trial. Choose the plan that fits
            your business and unlock unlimited users, dashboards, and insights.
          </p>
      ...
      >
        ...
        >
          Annual Pricing{" "}
          <span
            style={{ color: "#10b981", fontSize: "0.8rem", marginLeft: "5px" }}
          >
            (Save 20%)
          </span>
        </span>
              ...
              >
                ...
                <h3
                  style={{
                    fontSize: "1.5rem",
                    marginBottom: "0.5rem",
                    color: plan.highlight ? "#60a5fa" : "#fff",
                  }}
                >
                  {plan.name}
                </h3>
      ...
      <section style={{ padding: "4rem 0" }}>
        <div className="container">
          ...
          >
            Trusted by 20,000+ data-driven companies
          </p>
          <div
            style={{
              display: "flex",
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <p style={{ fontSize: "0.95rem", color: "#9ca3af" }}>
                You get full access to the Growth plan features for 14 days. No
            ...
            <div>
              ...
              <p style={{ fontSize: "0.95rem", color: "#9ca3af" }}>
                Yes, you can upgrade or downgrade at any time. Prorated charges
            ...
            <div>
              ...
              <p style={{ fontSize: "0.95rem", color: "#9ca3af" }}>
                We offer a 30-day money-back guarantee for all annual plans if
            ...
            <div>
              ...
              <p style={{ fontSize: "0.95rem", color: "#9ca3af" }}>
                Yes, for larger teams we offer custom contracts, invoicing, and
                dedicated support. Contact sales for details.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          ...
          >
            ...
            >
              No credit card needed. Unlimited access.
            </p>
