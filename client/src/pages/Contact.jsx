...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store/update leadId for future tracking
      if (response.data?.data?._id) {
        localStorage.setItem("leadId", response.data.data._id);

        // If this is a returning user with multiple interactions
        if (existingLeadId && existingLeadId === response.data.data._id) {
          console.log("Contact form submitted by returning lead");
        }
      }
      ...
      >
        ...
        >
          <div style={{ textAlign: "center", marginBottom: "5rem" }}>
            ...
            >
              Whether you need support, want a customized demo, or have a
              pricing question, our team is ready to help you thrive.
            </p>
          </div>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Speak directly to our sales team about custom solutions and
                    enterprise pricing.
                  </p>
                  <a
                    href="#"
              ...
              >
                ...
                <div>
                  ...
                  >
                    Current customers can reach out via our priority 24/7
